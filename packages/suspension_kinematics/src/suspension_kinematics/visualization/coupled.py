...
from suspension_kinematics.steering import TwoSegmentSteeringHardpoints3D
from suspension_kinematics.suspensions.base import Suspension
from suspension_kinematics.vehicle import (
    CoupledSweepResult,
...
from suspension_kinematics.visualization.plots import (
...
def create_coupled_animation(
    *,
    ...
    _, _, (x_mid, y_mid, z_mid, max_range) = compute_bounds_from_states(combined_states)
