...
from suspension_kinematics.gui.suspension.plotting import draw_suspension_curve_plot
...
OUTPUT_LABELS = {
    ...
    "svic_x_mm": "SVIC X [mm]",
    "svic_z_mm": "SVIC Z [mm]",
    "svsa_length_mm": "SVSA length [mm]",
    "fvic_y_mm": "FVIC Y [mm]",
    "fvic_z_mm": "FVIC Z [mm]",
    "fvsa_length_mm": "FVSA length [mm]",
