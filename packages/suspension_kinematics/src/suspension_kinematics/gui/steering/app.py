...
from suspension_kinematics.gui.steering.file_actions import SteeringFileActions
...
from suspension_kinematics.gui.steering.widgets import (
    CurveManager,
    HardpointEditor,
    OutputTable,
...
class SteeringWorkbenchApp(RefreshWorkflowMixin, SteeringFileActions):
    ...
    def _background_preview_worker(
        ...
        try:
            ...
            return
        self.background_refresh_queue.put(("preview", refresh_generation, state))
