...
from suspension_kinematics.gui.steering.plotting import (
    WHEEL_RADIUS,
    WHEEL_WIDTH,
    draw_curve_plot,
...
from suspension_kinematics.gui.suspension.plotting import (
    SuspensionPreviewRenderer,
    draw_suspension_curve_plot,
    draw_suspension_preview,
)
from suspension_kinematics.gui.suspension.reporting import (
...
from suspension_kinematics.steering.geometry import TwoSegmentSteeringSolution
from suspension_kinematics.steering.two_segment import solve_two_segment_steering
    ...
    *,
    ...
    try:
        ...
        raise ModuleNotFoundError(
            ...
            "Install/run with: uv run --extra viz suspension-kinematics gui"
        ) from exc
