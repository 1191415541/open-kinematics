...
def _build_default_corner_metrics() -> tuple[MetricDefinition, ...]:
    ...
    from suspension_kinematics.metrics.angles import (
        calculate_camber,
        calculate_caster,
        calculate_kpi,
        calculate_roadwheel_angle,
    )
    from suspension_kinematics.metrics.steering_geometry import (
        calculate_mechanical_trail,
        calculate_scrub_radius,
    )
    from suspension_kinematics.metrics.swing_arms import (
        calculate_fvsa_length,
        calculate_svsa_length,
    )
    from suspension_kinematics.metrics.vehicle_geometry import (
