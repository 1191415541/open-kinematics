...
from suspension_kinematics.gui.app import KinematicsWorkbenchApp
from suspension_kinematics.gui.hardpoint_merge import (
...
def test_main_gui_imports_suspension_hardpoints_into_steering_page() -> None:
    ...
    import suspension_kinematics.gui.app as gui_app
