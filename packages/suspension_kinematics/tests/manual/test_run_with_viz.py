...
from suspension_kinematics.core.constants import TEST_TOLERANCE
from suspension_kinematics.core.enums import Axis, PointID, TargetPositionMode
from suspension_kinematics.core.types import PointTargetAxis, SweepConfig
...
from suspension_kinematics.solver import PointTarget
...
def test_run_solver(
    ...
    from suspension_kinematics.visualization.animation import create_animation
    from suspension_kinematics.visualization.main import (
