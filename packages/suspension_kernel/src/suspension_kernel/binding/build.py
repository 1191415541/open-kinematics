...
SOURCE_RELATIVES = (
    "packages/suspension_kernel/cpp/src/config/kernel_config.cpp",
    "packages/suspension_kernel/cpp/src/numeric/angles.cpp",
    "packages/suspension_kernel/cpp/src/numeric/kernel_numeric.cpp",
    ...
    "packages/suspension_kernel/cpp/src/joint/kernel_model_constraint.cpp",
    "packages/suspension_kernel/cpp/src/joint/registry.cpp",
    ...
    "packages/suspension_kernel/cpp/src/tire/pac2002/scope.cpp",
    ...
    "packages/suspension_kernel/cpp/src/force/external_vector.cpp",
    "packages/suspension_kernel/cpp/src/tire/kernel_tire_assembly.cpp",
    "packages/suspension_kernel/cpp/src/element/spring.cpp",
    "packages/suspension_kernel/cpp/src/element/curves.cpp",
    "packages/suspension_kernel/cpp/src/element/bushing.cpp",
    "packages/suspension_kernel/cpp/src/element/anti_roll.cpp",
    "packages/suspension_kernel/cpp/src/element/steering.cpp",
    "packages/suspension_kernel/cpp/src/element/drive_brake.cpp",
    "packages/suspension_kernel/cpp/src/force/layout.cpp",
    "packages/suspension_kernel/cpp/src/element/directional.cpp",
    "packages/suspension_kernel/cpp/src/force/directional.cpp",
    "packages/suspension_kernel/cpp/src/tire/directional.cpp",
    "packages/suspension_kernel/cpp/src/dual/kernel_dual_algebra.cpp",
    "packages/suspension_kernel/cpp/src/joint/kernel_directional_constraint.cpp",
    "packages/suspension_kernel/cpp/src/linear/kernel_linear.cpp",
    "packages/suspension_kernel/cpp/src/solve_dynamic/kernel_integrator.cpp",
    "packages/suspension_kernel/cpp/src/solve_dynamic/kernel_integrator_residual.cpp",
    "packages/suspension_kernel/cpp/src/solve_dynamic/kernel_integrator_newton.cpp",
    "packages/suspension_kernel/cpp/src/solve_dynamic/kernel_integrator_step.cpp",
    "packages/suspension_kernel/cpp/src/solve_dynamic/kernel_integrator_state.cpp",
    "packages/suspension_kernel/cpp/src/input/kernel_input.cpp",
    "packages/suspension_kernel/cpp/src/assembly/build_model.cpp",
    "packages/suspension_kernel/cpp/src/solve_static/kernel_static_trim.cpp",
    "packages/suspension_kernel/cpp/src/solve_static/kernel_static_contact.cpp",
    "packages/suspension_kernel/cpp/src/solve_static/kernel_static_projection.cpp",
    "packages/suspension_kernel/cpp/src/assembly/registration.cpp",
    "packages/suspension_kernel/cpp/src/solve_dynamic/kernel_events.cpp",
    ...
    "packages/suspension_kernel/cpp/src/dual/dual_geometry.cpp",
    ...
    "packages/suspension_kernel/cpp/src/dual/curves.cpp",
    # Contract layer (library) and its standalone self-test executable: the
    # provenance list covers every C++ translation unit the package owns.
    "packages/suspension_kernel/cpp/src/contract/contract_container.cpp",
    "packages/suspension_kernel/cpp/src/contract/contract_json.cpp",
    "packages/suspension_kernel/cpp/src/contract/contract_registry.cpp",
    "packages/suspension_kernel/cpp/src/contract/contract_sha256.cpp",
    "packages/suspension_kernel/cpp/tests/contract_selftest.cpp",
    # Case layer (library): the documents-to-runs translation.
    "packages/suspension_kernel/cpp/src/cases/axle_dynamic.cpp",
    "packages/suspension_kernel/cpp/src/cases/case_dispatch.cpp",
    "packages/suspension_kernel/cpp/src/cases/contract_model.cpp",
    "packages/suspension_kernel/cpp/src/cases/handling.cpp",
    "packages/suspension_kernel/cpp/src/cases/kc_quasi_static.cpp",
    "packages/suspension_kernel/cpp/src/cases/ride_four_post.cpp",
    "packages/suspension_kernel/cpp/src/cases/ride_random_road.cpp",
    "packages/suspension_kernel/cpp/src/cases/vehicle_dynamic.cpp",
    "packages/suspension_kernel/cpp/src/cases/vehicle_kc.cpp",
    ...
    "packages/suspension_kernel/cpp/include/mb_contract/functions.hpp",
    "packages/suspension_kernel/cpp/include/mb_contract/types.hpp",
    "packages/suspension_kernel/cpp/include/mb_config/version.hpp",
    "packages/suspension_kernel/cpp/include/mb_config/constants.hpp",
    "packages/suspension_kernel/cpp/include/mb_config/diagnostics.hpp",
    ...
    "packages/suspension_kernel/cpp/include/mb_numeric/monotone_cubic.hpp",
    "packages/suspension_kernel/cpp/include/mb_config/prelude.hpp",
    "packages/suspension_kernel/cpp/include/mb_numeric/util.hpp",
    "packages/suspension_kernel/cpp/include/mb_numeric/vector.hpp",
    "packages/suspension_kernel/cpp/include/mb_joint/functions.hpp",
    "packages/suspension_kernel/cpp/include/mb_joint/registry.hpp",
    "packages/suspension_kernel/cpp/include/mb_joint/types.hpp",
    "packages/suspension_kernel/cpp/include/mb_solve_dynamic/context.hpp",
    "packages/suspension_kernel/cpp/include/mb_solve_dynamic/functions.hpp",
    "packages/suspension_kernel/cpp/include/mb_linear/factorization_types.hpp",
    "packages/suspension_kernel/cpp/include/mb_linear/functions.hpp",
    ...
    "packages/suspension_kernel/cpp/include/mb_solve_static/functions.hpp",
    "packages/suspension_kernel/cpp/include/mb_assembly/functions.hpp",
    "packages/suspension_kernel/cpp/include/mb_element/functions.hpp",
    "packages/suspension_kernel/cpp/include/mb_force/functions.hpp",
    ...
    "packages/suspension_kernel/cpp/include/mb_energy/types.hpp",
    "packages/suspension_kernel/cpp/include/mb_input/types.hpp",
    "packages/suspension_kernel/cpp/include/mb_input/functions.hpp",
