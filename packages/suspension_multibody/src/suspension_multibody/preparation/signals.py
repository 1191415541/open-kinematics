"""
Input-signal sampling for the sampled quasi-static cases.

A time grid, a prescribed motion and the wrenches at one time are *authoring*
inputs: they are what a case document is written from, before anything runs.
That is why they live in preparation rather than beside the result readers --
report publishes what came back, it does not author what goes in.  Moved here
from ``analysis/time_signals.py``, which 08 deletes.
"""
