...
joint axis or an attachment pose is converted here, before it is authored, and
nothing here reads a result.  The result side of the same conversions lives in
