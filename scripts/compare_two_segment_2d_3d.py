        ...
        rows.append(
            {
                ...
                "left_wheel_center_dx": float(
                    comparison.left_wheel_center_delta_2d[0]
                ),
                "left_wheel_center_dy": float(
                    comparison.left_wheel_center_delta_2d[1]
                ),
...
def main() -> None:
    ...
    print(
        "max_abs_wheel_angle_delta_deg="
        f"{result['max_abs_wheel_angle_delta_deg']:.6f}"
    )
